// @ts-check
// @description Every date and timestamp column reads the US way, 9/23/2026, 11:15 AM, the server value on hover
// @color green
...
export default [
  {
    ...
    fn: (value) => {
      ...
      const fmt = new Intl.DateTimeFormat('en-US', isDay(value) ? DATE : { ...DATE, ...TIME })
